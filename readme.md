...
<table width="100%">
  <tr style="background: #0b0f19;">
    ...
    <th width="33%" align="left" style="color: #00f2fe; border: 1px solid #1e293b; padding: 10px;">💻 Full-Stack Node</th>
    <th width="33%" align="left" style="color: #00f2fe; border: 1px solid #1e293b; padding: 10px;">☁️ Infrastructure Planes</th>
  </tr>
  <tr>
    <td valign="top" style="border: 1px solid #1e293b; padding: 15px; line-height: 1.6;">
...
* **Architecture:** Formulated a high-performance, carbon-aware LLM proxy infrastructure via **FastAPI** and **Docker** environments to minimize environmental footprint overhead metrics[cite: 1].
...
<div align="center">
  ...
  <sub>TERMINAL REFRESH LOOP: CONTINUOUS // EXECUTION THREAD ACTIVE</sub>
</div>
